/**
 * Row → app-type mappers and unique temp-ID generation.
 *
 * Extracted verbatim from useSupabaseData.ts (the data hook now imports these).
 * Each map*Row converts a Supabase row to the canonical domain shape declared
 * in ./domainTypes.
 */
...
import { visibleStudentIdentifier } from './studentIdentifiers';
