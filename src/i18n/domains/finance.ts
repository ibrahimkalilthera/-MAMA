...
export const en = {
    ...
    addTechMember: "Add Technical Center Member",
    addAdminMember: "Add Administration Member",
    staffFilterAll: "All staff",
    staffFilterAdmin: "Administration",
    staffFilterEmployees: "Employees",
    staffFilterTechnique: "Technical Center",
    staffPositionFilterLabel: "Filter by position",
    adminMembersSingular: "{count} administration member",
    adminMembersPlural: "{count} administration members",
    recordSalary: "Record Salary",
    salaryAmountExceedsMonthlySalary: "The amount cannot exceed the monthly salary.",
    addExpense: "Add Expense",
    generalExpensesTabLabel: "General Expenses",
    vendorExpensesTabLabel: "Vendors & Services",
    ...
    staffPayrollDetails: "Payroll & Social Details",
    staffInpsNumber: "INPS Number",
    staffHireDate: "Hire Date",
    staffFamilyStatus: "Family Status",
    staffChildrenCount: "Number of Children",
    staffTravelAllowance: "Travel Allowance",
    staffCommunicationAllowance: "Communication Allowance",
    staffHousingAllowance: "Housing Allowance",
    familySingle: "Single",
...
export const fr = {
    ...
    addTechMember: "Ajouter un Membre du Centre Technique",
    addAdminMember: "Ajouter un Membre de l'Administration",
    staffFilterAll: "Tout le personnel",
    staffFilterAdmin: "Administration",
    staffFilterEmployees: "Employés",
    staffFilterTechnique: "Centre Technique",
    staffPositionFilterLabel: "Filtrer par poste",
    adminMembersSingular: "{count} membre de l'administration",
    adminMembersPlural: "{count} membres de l'administration",
    recordSalary: "Enregistrer Salaire",
    salaryAmountExceedsMonthlySalary: "Le montant ne peut pas dépasser le salaire mensuel.",
    addExpense: "Ajouter une Dépense",
    generalExpensesTabLabel: "Dépenses générales",
    vendorExpensesTabLabel: "Fournisseurs & Services",
    numberOfEntries: "Nombre d'opérations",
    position: "Poste",
    ...
    staffPayrollDetails: "Détails de paie & sociaux",
    staffInpsNumber: "N° INPS",
    staffHireDate: "Date d'entrée",
    staffFamilyStatus: "Situation familiale",
    staffChildrenCount: "Nombre d'enfants",
    staffTravelAllowance: "Indemnité de déplacement",
    staffCommunicationAllowance: "Indemnité de communication",
    staffHousingAllowance: "Indemnité de logement",
    familySingle: "Célibataire",
    familyMarried: "Marié(e)",
    familyDivorced: "Divorcé(e)",
    familyWidowed: "Veuf(ve)",
