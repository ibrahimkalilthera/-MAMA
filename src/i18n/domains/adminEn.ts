...
export const en = {
  ...
  outstandingNoComparison: "no payments last month to compare",
    ...
    auditFilterAllRoles: "All roles",
    auditFilterCount: "{shown} / {total} entries",
    ...
    auditFilterGroupIncidents: "Group blocks",
    auditIncidentAction: "PC blocked ({code})",
    auditIncidentMotif: "Failure",
    auditIncidentStations: "PCs",
    auditIncidentCount: "{count} PC(s)",
    auditIncidentOccurrences: "{count} reported failure(s)",
    auditIncidentSpan: "from {from} to {to}",
    auditIncidentMore: "+{count} more",
    auditIncidentShow: "Show PCs",
    auditIncidentHide: "Hide PCs",
    ...
    updateRestartNow: "Restart",
    updateDownloadNow: "Download",
    updateDismiss: "Dismiss",
    updateForcedTitle: "Update required",
    updateForcedMajor: "You are on {current}; version {version} is available — {behind} major version(s) behind.",
    updateForcedMinor: "You are on {current}; version {version} is available — {behind} minor version(s) behind.",
    updateForcedAge: "Version {version} was published {days} days ago and this PC has not installed it.",
    updateForcedNote: "This update cannot be postponed: a PC left behind runs different software than the others.",
    updateForcedFailed: "The download failed: {detail}",
    updateForcedRetry: "Retry",
    updateForcedContinue: "Continue without updating",
    updateBlockedTitle: "PC blocked",
    updateBlockedDetail: "Reason recorded in this PC's journal: {detail}",
    updateBlockedReportPending: "Reporting to the administrator…",
    updateBlockedReportSent: "Reported to the administrator — the audit journal carries this block.",
    updateBlockedReportLocal: "No connection: this block could only be recorded in the PC's own journal ({path}).",
    updateBlockedJournal: "Open the PC journal",
    revenue: "Revenue",
