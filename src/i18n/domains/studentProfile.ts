...
export const en = {
  ...
  save: "Save",
    ...
    aiResponseBalance: "The current school cash balance is {balance}, with total collected fees of {income} and total expenses of {expenses} this month.",
    aiResponseOverdue: "There are currently {count} students with overdue balances, totaling {amount} in outstanding debt.",
    aiResponseExpenses: "Expenses this month total {expenses}, with major items including {categories}.",
    aiResponsePayroll: "The staff directory has {count} employees. Total monthly salary liability is {salary}, with {unpaidCount} unpaid salaries.",
...
export const fr = {
  ...
  save: "Enregistrer",
    ...
    aiResponseBalance: "Le solde de caisse actuel de l'école est de {balance}, avec un total de frais collectés de {income} et des dépenses totales de {expenses} ce mois-ci.",
    aiResponseOverdue: "Il y a actuellement {count} élèves avec des soldes en retard, pour un total de {amount} de dette impayée.",
    aiResponseExpenses: "Les dépenses de ce mois s'élèvent à {expenses}, avec des postes majeurs comprenant {categories}.",
    aiResponsePayroll: "L'annuaire du personnel compte {count} employés. La masse salariale mensuelle totale est de {salary}, avec {unpaidCount} salaires impayés.",
