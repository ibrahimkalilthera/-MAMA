...
import { CATEGORY_LABELS, TARGET_FIELDS, type ImportCategory } from '../lib/excelImporter';
import { useExcelImportWizard, type ImportOptions } from '../app/useExcelImportWizard';
...
export type { ImportOptions } from '../app/useExcelImportWizard';
...
export function ExcelImportModal({
  ...
  // Wizard state + handlers live in the hook (split campaign, no behavior change).
  const {
    step, setStep, file, setFile, sheets, setSheets, selectedSheetIdx, setSelectedSheetIdx,
    detection, setDetection, category, setCategory, mappings, setMappings, validation, setValidation,
    importOptions, setImportOptions, isProcessing, isParsing, importResult, setImportResult,
    dragOver, setDragOver, fileInputRef,
    resetWizard, processFile, handleFileChange, handleDrop, handleSheetChange,
    proceedToMapping, updateMappingTarget, proceedToValidation, executeImport,
  } = useExcelImportWizard({ selectedYear, onImportComplete });
