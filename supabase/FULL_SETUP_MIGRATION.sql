...
-- (single source of truth — replaces the old custom_grades table)
...
CREATE POLICY "Authenticated read custom classes" ON public.custom_classes FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "Authenticated insert custom classes" ON public.custom_classes;
CREATE POLICY "Authenticated insert custom classes" ON public.custom_classes FOR INSERT TO authenticated WITH CHECK (true);

DROP POLICY IF EXISTS "Authenticated update custom classes" ON public.custom_classes;
CREATE POLICY "Authenticated update custom classes" ON public.custom_classes FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Authenticated delete custom classes" ON public.custom_classes;
CREATE POLICY "Authenticated delete custom classes" ON public.custom_classes FOR DELETE TO authenticated USING (true);
...
-- custom_classes, then drop custom_grades (no-op on fresh databases).
DO $$
BEGIN
