...
// Le CONTEXTE dont une vue a besoin vit dans `tests/views-harness.tsx` : ici on ne
// garde que ce qui sert à EXERCER les vues — les composants, le DOM, les
// traductions attendues, et l'entrée du harnais. Le contexte figé avait deux
// conséquences, pas une : aucune autre suite ne pouvait rendre une vue avec des
// données, et un cas qui oubliait de peupler une collection mesurait un contexte
...
import { makeProps, renderWithContext } from './views-harness';
