...
- **Tests (`npm test`)**: 53/53 passing (formatters, excel importer, offline queue replay, view rendering inside MainViewsContext, MainViewsProps contract).
